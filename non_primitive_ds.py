...
#     principle
#   Insertion operations take place from rear(back) end
#   Deletion opertions take place from front end

#   Analogy
#   Like a queue at ticket counter
...
#  3) Checking first(frontmost) element
#   front()
...
queue.append(20)
queue.append(30)
queue.pop(0)  # SLOW because of shifting
print(queue)  # [20, 30]
...
#   A special data structure that allows insertion and deletion
#    at both ends

from collections import deque

queue = deque()  # Created an empty deque data structure
queue.append(10)
queue.append(20)
queue.append(30)
queue.popleft()
